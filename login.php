...
<body>
    ...
    <main class="auth-minimal-wrapper">
        ...
        <img src="assets/images/logo-full.jpeg" alt="HADAF-KAAL Logo" class="login-brand-logo" style="width:230px; margin-bottom: -73px;
    margin-top: 50px;" >
    
</div>
                   <div class="card-body p-sm-5">
    <div class="text-center mb-5">
        <h2 class="fs-22 fw-bold text-dark mb-2">Login</h2>
    ...
    <form  method="POST" class="w-100 mt-4">
        ...
        <div class="mb-4">
            <label class="form-label small fw-bold text-uppercase text-muted">User</label>
            <div class="input-group">
                <span class="input-group-text bg-light border-end-0">
                    <i class="feather-mail text-primary"></i>
                </span>
                <input type="text" name='email' class="form-control border-start-0 ps-0" placeholder="Username" required>
            </div>
        </div>
        ...
        <div class="d-flex align-items-center justify-content-between mb-4">
            <div class="form-check custom-checkbox">
                ...
                <label class="form-check-label c-pointer fs-11 text-muted" for="rememberMe">Remember Me</label>
            </div>
            
        </div>

        <div class="mt-5">
            <button type="submit" class="btn btn-lg btn-primary w-100 shadow-sm fw-bold text-uppercase py-3" style="background: linear-gradient(45deg, #007bff, #0056b3); border: none;">
...
<?php
// 1. Session-ka waa inuu halkan ku bilowdaa haddii uusan faylka kale ku jirin
...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    if ($user && $password == $user['password']) {
        ...
        // MUHIIM: Ha isticmaalin 'echo' halkan ka hor header()
        header("Location: index.php");
        exit(); 
    } else {
        $login_error = "Email ama Password khaldan!";
    }
}
?>
                </div>
