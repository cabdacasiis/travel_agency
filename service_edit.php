<?php
session_start(); // Tani waa inay ahaataa line-ka ugu horreeya
require_once "conn.php";

// Haddii session-ku uusan jirin, qofka dib ugu celi login.php si uusan qalad u arkin
         ...
         <div class="navbar-wrapper">
            <div class="m-header">
                <a href="index.php" class="b-brand">
                   ...
                   <img src="assets/images/logo_2.png" alt="HADAF-KAAL Logo" class="logo logo-lg img-fluid" style="max-height: 153px; border-radius: 8px; width:200px;">
                ...
                <ul class="nxl-navbar">
                    ...
                    <li class="nxl-item nxl-hasmenu">
                        <a href="javascript:void(0);" class="nxl-link">
                            ...
                            <span class="nxl-mtext">Bookings</span><span class="nxl-arrow"><i class="feather-chevron-right"></i></span>
                        </a>
                        <ul class="nxl-submenu">
                    ...
                    <li class="nxl-item nxl-hasmenu">
                        ...
                        <ul class="nxl-submenu">
                            ...
                            <li class="nxl-item"><a class="nxl-link" href="customers-care.php">Customers Care</a></li>
                        </ul>
                    </li>
                    ...
                    <div class="dropdown nxl-h-item">
                        ...
                        <div class="dropdown-menu dropdown-menu-end nxl-h-dropdown nxl-user-dropdown">
                            <div class="dropdown-header">
                                <div class="d-flex align-items-center">
                                    <img src="assets/images/avatarn.jpg" alt="user-image" class="img-fluid user-avtar" />
                                    <div>
                                        <h6 class="text-dark mb-0">Abdiaziiz Abdale<span class="badge bg-soft-success text-success ms-1">PRO</span></h6>
...
// 1. Soo qabo ID-ga guriga la rabo in la bedelo
if (isset($_GET['id'])) {
    $id = (int)$_GET['id'];
    ...
    if (!$property) {
        die("Xogta lama helin!");
    }
}

// 2. Marka la gujiyo "Update Property"
if ($_SERVER['REQUEST_METHOD'] == 'POST') {
    ...
    $status   = mysqli_real_escape_string($con, $_POST['status']); // Status-ka halkan ayuu soo galayaa
    $size     = mysqli_real_escape_string($con, $_POST['size']);
    $beds     = (int)$_POST['beds'];
    $baths    = (int)$_POST['baths'];

    // Maareynta Sawirka (Haddii sawir cusub la doorto)
    if (!empty($_FILES['image']['name'])) {
        $image_name = $_FILES['image']['name'];
        $target_file = "uploads/" . basename($image_name);
        move_uploaded_file($_FILES['image']['tmp_name'], $target_file);
        
        $sql = "UPDATE properties SET title='$title', location='$location', price='$price', category='$category', 
                status='$status', image='$image_name', size='$size', beds='$beds', baths='$baths' WHERE id=$id";
    } else {
        // Haddii sawirkii hore loo deynayo
        $sql = "UPDATE properties SET title='$title', location='$location', price='$price', category='$category', 
                status='$status', size='$size', beds='$beds', baths='$baths' WHERE id=$id";
    }

    if (mysqli_query($con, $sql)) {
        echo "<script>alert('Data saved successfully!'); window.location.href='service_list.php';</script>";
    } else {
        echo "Khalad dhacay: " . mysqli_error($con);
    }
}
?>
<main class="nxl-container">
    <div class="nxl-content">
        <div class="page-header mb-4">
            <div class="page-header-left">
                <h4 class="fw-bold text-dark">Edit Property Details</h4>
                <p class="text-muted small">Cusboonaysii macluumaadka guriga ama dhulka.</p>
            </div>
        </div>
        ...
        <div class="main-content">
            <div class="card card-body shadow-sm border-0">
                <h4 class="mb-4 text-dark fw-bold">
                    ...
                    Edit Property: <?php echo htmlspecialchars($property['title']); ?>
                </h4>
                ...
                <form action="" method="POST" enctype="multipart/form-data">
                    ...
                    <div class="row">
                        <div class="col-md-6 mb-3">
                            ...
                            <input type="text" name="title" class="form-control form-control-lg" value="<?php echo htmlspecialchars($property['title']); ?>" placeholder="Al Furqaan Luxury Suite">
                        </div>
                        <div class="col-md-6 mb-3">
                            <label class="form-label fw-bold">Location</label>
                            <input type="text" name="location" class="form-control form-control-lg" value="<?php echo htmlspecialchars($property['location']); ?>" placeholder="Wadajir, Garowe">
                        </div>

                        <div class="col-md-6 mb-3">
                            <label class="form-label fw-bold">Price ($)</label>
                            <input type="text" name="price" class="form-control form-control-lg" value="<?php echo htmlspecialchars($property['price']); ?>" placeholder="Tusaale: $350/mo">
                        </div>
                        <div class="col-md-6 mb-3">
                            <label class="form-label fw-bold">Category</label>
                            <select name="category" class="form-select form-select-lg">
                                <option value="For Rent" <?php if($property['category'] == 'For Rent') echo 'selected'; ?>>For Rent</option>
                                <option value="For Sale" <?php if($property['category'] == 'For Sale') echo 'selected'; ?>>For Sale</option>
                            </select>
                        </div>

                        <div class="col-md-6 mb-3">
                            <label class="form-label text-primary fw-bold">Status</label>
                            <select name="status" class="form-select form-select-lg border-primary fw-bold text-primary">
                                <option value="Active" <?php if($property['status'] == 'Active') echo 'selected'; ?>>Active</option>
                        ...
                        <div class="col-md-6 mb-3">
                            ...
                            <input type="text" name="size" class="form-control form-control-lg" value="<?php echo htmlspecialchars($property['size']); ?>" placeholder="Tusaale: 180sm">
                        </div>

                        <div class="col-md-6 mb-3">
                            <label class="form-label fw-bold">Beds</label>
                            <input type="number" name="beds" class="form-control form-control-lg" value="<?php echo $property['beds']; ?>">
                        </div>
                        <div class="col-md-6 mb-3">
                            <label class="form-label fw-bold">Baths</label>
                            <input type="number" name="baths" class="form-control form-control-lg" value="<?php echo $property['baths']; ?>">
                        </div>
                        ...
                        <div class="col-md-12 mb-4">
                            ...
                            <div class="mt-2 p-2 bg-light rounded d-flex align-items-center">
                                ...
                                <small class="text-muted">Current File: <strong><?php echo $property['image']; ?></strong></small>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="d-flex align-items-center gap-3 mt-4">
                        ...
                        <a href="service_list.php" class="btn btn-outline-danger px-4 py-2 fw-bold text-decoration-none">
                            CANCEL
                        </a>
                    </div>
                </form>
    ...
    <p class="mb-0 fs-11 fw-medium text-muted">
        Developed by: <a href="mailto:cabdacasiiscabdle@gmail.com" class="text-primary fw-bold">Abdiaziiz Abdale Salim</a> 
...
<div class="theme-customizer">
    ...
    <div class="customizer-sidebar-wrapper">
        ...
        <div class="customizer-sidebar-body position-relative p-4" data-scrollbar-target="#psScrollbarInit">
            ...
            </div> <div class="customizer-sidebar-footer px-4 ht-60 border-top d-flex align-items-center gap-2">
