<?php
include('conn.php'); // Hubi xiriirka database-ka

// Ka soo qaad dhammaan dadka ku jira admin_users
...
<body>
    ...
    <div class="card mb-0">
        <div class="card-header d-flex justify-content-between align-items-center">
            ...
            <a href="settings-User.php" class="btn btn-primary btn-sm">
                ...
                <table class="table table-hover mb-0">
                    ...
                    <tbody>
                            ...
                            <td class="text-end">
                                <div class="dropdown">
                                    ...
                                    <ul class="dropdown-menu dropdown-menu-end">
                                        <li><a class="dropdown-item" href="edit-user.php?id=<?php echo $row['id']; ?>"><i class="feather-edit me-2"></i> Edit</a></li>
                                        <li><a class="dropdown-item text-danger" href="delete-user.php?id=<?php echo $row['id']; ?>" onclick="return confirm('Ma hubtaa inaad tirtirto user-kan?')"><i class="feather-trash me-2"></i> Delete</a></li>
                                    </ul>
                                </div>
                            </td>
                        </tr>
                        <?php 
                            ...
                            echo "<tr><td colspan='7' class='text-center'>Wax xog ah laguma hayo database-ka.</td></tr>";
                        }
                        ?>
                    </tbody>
                </table>
