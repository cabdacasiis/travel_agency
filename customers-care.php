...
<head>
    ...
    <!--! BEGIN: Apps Title-->
    <title>Duralux || Customers Care</title>
    <!--! END:  Apps Title-->
    <!--! BEGIN: Favicon-->
            ...
            <div class="navbar-content">
                <ul class="nxl-navbar">
                    ...
                    <li class="nxl-item nxl-hasmenu">
                        ...
                        <ul class="nxl-submenu">
                            <li class="nxl-item"><a class="nxl-link" href="settings-User.php">User</a></li>
                        ...
                        <div class="card-body p-0">
                            <div class="table-responsive">
                                <table class="table table-hover mb-0">
                                    ...
                                    <tbody>
                                        <?php 
                                        // Hubi in $result uu yahay query-ga saxda ah (SELECT * FROM table_name)
                                        while($row = mysqli_fetch_assoc($result)): 
                                            // Waxaan saxay ID-ga maadaama database-kaaga uu ku qoran yahay 'Id'
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <div class="d-flex align-items-center">
                                                    <div class="avatar-text avatar-md bg-soft-primary text-primary me-3 fw-bold">
                                                        <?php echo strtoupper(substr($row['full_name'], 0, 1)); ?>
                                                    </div>
                                                    <div>
                                                        <span class="fw-bold d-block text-dark"><?php echo $row['full_name']; ?></span>
                                                    </div>
                                                </div>
                                            </td>
                                            <td>
                                                <div class="small text-muted mb-1"><i class="bi bi-envelope-at me-1"></i><?php echo $row['email']; ?></div>
                                                <div class="fw-bold text-dark"><i class="bi bi-telephone me-1"></i><?php echo $row['mobile']; ?></div>
                                            </td>
                                            <td>
                                                <span class="badge rounded-pill bg-soft-primary text-primary border border-primary-subtle px-3">
                                                    <?php echo $row['Subject']; ?>
                                                </span>
                                            </td>
                                            <td class="text-end pe-4">
                                                <div class="dropdown">
                                                    <a href="javascript:void(0);" class="btn btn-icon btn-sm btn-light-brand" data-bs-toggle="dropdown">
                                                        <i class="bi bi-three-dots-vertical"></i>
                                                    </a>
                                                    <ul class="dropdown-menu dropdown-menu-end shadow-lg border-0 py-2" style="position: relative  !important;  z-index:1000 !important;">
                                                        <li>
                                                            <a class="dropdown-item d-flex align-items-center py-2" href="javascript:void(0);" data-bs-toggle="modal" data-bs-target="#viewMsg<?php echo $row_id; ?>">
                                                                <i class="bi bi-eye-fill me-2 text-primary"></i>
                                                                <span>View</span>
                                                            </a>
                                                        </li>
                                                        <li>
                                                            <a class="dropdown-item d-flex align-items-center py-2 text-success" href="https://wa.me/<?php echo $phone; ?>" target="_blank">
                                                                <i class="bi bi-whatsapp me-2"></i>
                                                                <span>WhatsApp</span>
                                                            </a>
                                                        </li>
                                                        <li>
                                                            <a class="dropdown-item d-flex align-items-center py-2 text-warning" href="mailto:<?php echo $row['email']; ?>">
                                                                <i class="bi bi-envelope-open me-2"></i>
                                                                <span>Email</span>
                                                            </a>
                                                        </li>
                                                        <li>
                                                            <a class="dropdown-item d-flex align-items-center py-2 text-info" href="edit-customer.php?id=<?php echo $row_id; ?>">
                                                        ...
                                                        <li>
                                                            <a class="dropdown-item d-flex align-items-center py-2 text-danger" href="?delete=<?php echo $row_id; ?>" onclick="return confirm('Are you sure you want to delete this message?')">
                                        ...
                                        <div class="modal fade" id="viewMsg<?php echo $row_id; ?>" tabindex="-1" aria-hidden="true">
                                            <div class="modal-dialog modal-dialog-centered">
                                                <div class="modal-content border-0 shadow-lg">
                                                    ...
                                                    <div class="modal-body p-4">
                                                        <div class="mb-3">
                                                            <label class="small text-uppercase text-muted fw-bold">From:</label>
                                                            <p class="h6 text-dark"><?php echo $row['full_name']; ?></p>
                                                        </div>
                                                        <div class="mb-3">
                                                            <label class="small text-uppercase text-muted fw-bold">Subject:</label>
                                                            <p class="h6 text-dark"><?php echo $row['Subject']; ?></p>
                                                        </div>
                                                        <div class="mb-0">
                                                            <label class="small text-uppercase text-muted fw-bold">Message Content:</label>
                                                            <div class="p-3 bg-light rounded text-dark lh-base mt-2" style="white-space: pre-wrap;"><?php echo $row['message']; ?></div>
                                                        </div>
                                                    </div>
                                                    <div class="modal-footer border-0 p-3">
                                                        <button type="button" class="btn btn-light-danger" data-bs-dismiss="modal">Close</button>
                                                        <a href="mailto:<?php echo $row['email']; ?>" class="btn btn-primary">Reply via Email</a>
                                                    </div>
                                                </div>
                                            </div>
                                        </div>
