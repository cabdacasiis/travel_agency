...
if (isset($_POST['submit_booking'])) {
    // Waxaan isticmaalaynaa ?? '' si haddii xogta la dhowro uusan Warning u soo bixin
    ...
    $request_type = mysqli_real_escape_string($con, $_POST['request_type'] ?? 'Iib (Sale)');
    $message      = mysqli_real_escape_string($con, $_POST['message'] ?? '');
    $status       = "New";

    $sql = "INSERT INTO property_bookings (property_id, full_name, email, nationality, city, phone, request_type, message, status) 
            VALUES ('$property_id', '$full_name', '$email', '$nationality', '$city', '$phone', '$request_type', '$message', '$status')";

    if (mysqli_query($con, $sql)) {
        echo "<script>alert('Booking si guul leh ayaa loo daray!'); window.location.href='property_list.php';</script>";
        exit();
    } else {
        $error = "Khalad: " . mysqli_error($con);
    }
}
?>
        ...
        <div class="page-header">
            <div class="page-header-left d-flex align-items-center">
                <div class="page-header-title">
                    <h5 class="m-b-10">Add New Request</h5>
                </div>
            </div>
        </div>
                    ...
                    <form action="" method="POST">
                        <div class="row">
                            <div class="col-md-6 mb-4">
                                ...
                                <input type="text" name="full_name" class="form-control" placeholder="Geli magaca oo dhamaystiran" required>
                            </div>

                            <div class="col-md-6 mb-4">
                                <label class="form-label fw-bold">Property ID</label>
                                <input type="number" name="property_id" class="form-control" placeholder="Tusaale: 101" required>
                            </div>

                            <div class="col-md-6 mb-4">
                                <label class="form-label fw-bold">Email Address</label>
                                <input type="email" name="email" class="form-control" placeholder="Email-ka" required>
                            </div>
                            <div class="col-md-6 mb-4">
                            ...
                            <div class="col-md-12 mt-3">
                                <div class="d-flex align-items-center gap-2">
                                    <button type="submit" name="submit_booking" class="btn btn-primary px-4">
                                        <i class="feather-save me-2"></i>SAVE PROPERTY
                                    </button>
