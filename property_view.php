...
if (isset($_GET['id'])) {
    ...
    $query = "SELECT pb.*, 
              ...
              LEFT JOIN properties p ON pb.property_id = p.id 
              WHERE pb.id = '$id'";
    ...
    if ($result && mysqli_num_rows($result) > 0) {
        ...
        die("<div style='text-align:center; padding:50px;'><h2>Cilad: Dalabkan lama helin!</h2><a href='property_list.php'>Ku laabo liiska</a></div>");
    }
} else {
...
// XALKA QALDKA: Hubi haddii qiimuhu lambaar yahay ka hor intaanan format-gareyn
$raw_price = $row['price'] ?? 0;
if (is_numeric($raw_price)) {
    $display_price = "$" . number_format($raw_price, 2);
} else {
    // Haddii ay ku jirto "500/month", sidooda u daabac
    $display_price = htmlspecialchars($raw_price);
}
?>
<!DOCTYPE html>
<html lang="zxx">
...
<head>
    ...
    <!--! BEGIN: Apps Title-->
    <title>Hadaf-Kaal</title>
    <!--! END:  Apps Title-->
    <!--! BEGIN: Favicon-->
    <link rel="shortcut icon" type="image/x-icon" href="assets/images/logo_2" />
    <!--! END: Favicon-->
    <!--! BEGIN: Bootstrap CSS-->
        ...
        <div class="navbar-wrapper">
            <div class="m-header">
                <a href="index.php" class="b-brand">
                    ...
                    <img src="assets/images/logo_2.png" alt="HADAF-KAAL Logo" class="logo logo-lg img-fluid"
                        style="max-height: 153px; border-radius: 8px; width:200px;">
                    <img src="assets/images/logo_2.png" alt="" class="logo logo-sm" />
                </a>
            </div>
                ...
                <ul class="nxl-navbar">
                    ...
                    <li class="nxl-item nxl-hasmenu">
                        <a href="javascript:void(0);" class="nxl-link">
                            ...
                            <span class="nxl-mtext">Bookings</span><span class="nxl-arrow"><i
                                    class="feather-chevron-right"></i></span>
                        </a>
                        <ul class="nxl-submenu">
                            <li class="nxl-item"><a class="nxl-link" href="property_list.php">Property</a></li>
                    ...
                    <li class="nxl-item nxl-hasmenu">
                        ...
                        <ul class="nxl-submenu">
                            ...
                            <li class="nxl-item"><a class="nxl-link" href="customers-care.php">Customers Care</a>
                            </li>
                        </ul>
                    </li>
                    ...
                    <li class="nxl-item nxl-hasmenu">
                        ...
                        <ul class="nxl-submenu">
                            <li class="nxl-item"><a class="nxl-link" href="list-user.php">User</a></li>
                            ...
                            <li class="nxl-item"><a class="nxl-link" href="settings-localization.php">Localization</a>
                            </li>
                            <li class="nxl-item"><a class="nxl-link" href="settings-recaptcha.php">reCAPTCHA</a></li>
                            <li class="nxl-item"><a class="nxl-link" href="settings-miscellaneous.php">Miscellaneous</a>
                            </li>
                        </ul>
                    </li>
                    <li class="nxl-item nxl-hasmenu">
                        ...
                        <ul class="nxl-submenu">
                            <li class="nxl-item nxl-hasmenu">
                                ...
                                <ul class="nxl-submenu">
                                    <li class="nxl-item"><a class="nxl-link" href="./auth-login-cover.php">Cover</a>
                                    </li>
                                    <li class="nxl-item"><a class="nxl-link" href="./login.php">Minimal</a></li>
                                    <li class="nxl-item"><a class="nxl-link"
                                            href="./auth-login-creative.php">Creative</a></li>
                                </ul>
                            </li>
                            <li class="nxl-item nxl-hasmenu">
                                <a href="javascript:void(0);" class="nxl-link">
                                ...
                                <ul class="nxl-submenu">
                                    <li class="nxl-item"><a class="nxl-link" href="./auth-register-cover.php">Cover</a>
                                    </li>
                                    <li class="nxl-item"><a class="nxl-link"
                                            href="./auth-register-minimal.php">Minimal</a></li>
                                    <li class="nxl-item"><a class="nxl-link"
                                            href="./auth-register-creative.php">Creative</a></li>
                                </ul>
                            </li>
                            <li class="nxl-item nxl-hasmenu">
                                <a href="javascript:void(0);" class="nxl-link">
                                ...
                                <ul class="nxl-submenu">
                                    ...
                                    <li class="nxl-item"><a class="nxl-link" href="./auth-404-minimal.php">Minimal</a>
                                    </li>
                                    <li class="nxl-item"><a class="nxl-link" href="./auth-404-creative.php">Creative</a>
                                    </li>
                                </ul>
                            </li>
                            <li class="nxl-item nxl-hasmenu">
                                ...
                                <ul class="nxl-submenu">
                                    <li class="nxl-item"><a class="nxl-link" href="./auth-reset-cover.php">Cover</a>
                                    </li>
                                    <li class="nxl-item"><a class="nxl-link" href="./auth-reset-minimal.php">Minimal</a>
                                    </li>
                                    <li class="nxl-item"><a class="nxl-link"
                                            href="./auth-reset-creative.php">Creative</a></li>
                                </ul>
                            </li>
                            <li class="nxl-item nxl-hasmenu">
                                <a href="javascript:void(0);" class="nxl-link">
                                ...
                                <ul class="nxl-submenu">
                                    <li class="nxl-item"><a class="nxl-link" href="./auth-verify-cover.php">Cover</a>
                                    </li>
                                    <li class="nxl-item"><a class="nxl-link"
                                            href="./auth-verify-minimal.php">Minimal</a></li>
                                    <li class="nxl-item"><a class="nxl-link"
                                            href="./auth-verify-creative.php">Creative</a></li>
                                </ul>
                            </li>
                            <li class="nxl-item nxl-hasmenu">
                                <a href="javascript:void(0);" class="nxl-link">
                                ...
                                <ul class="nxl-submenu">
                                    <li class="nxl-item"><a class="nxl-link"
                                            href="./auth-maintenance-cover.php">Cover</a></li>
                                    <li class="nxl-item"><a class="nxl-link"
                                            href="./auth-maintenance-minimal.php">Minimal</a></li>
                                    <li class="nxl-item"><a class="nxl-link"
                                            href="./auth-maintenance-creative.php">Creative</a></li>
                                </ul>
                            </li>
                        </ul>
                    </li>
                    <li class="nxl-item nxl-hasmenu">
                        ...
                        <ul class="nxl-submenu">
                            ...
                            <li class="nxl-item"><a class="nxl-link" href="help-knowledgebase.php">KnowledgeBase</a>
                            </li>
                ...
                <div class="d-flex align-items-center">
                    ...
                    <div class="dropdown nxl-h-item">
                        <a href="javascript:void(0);" data-bs-toggle="dropdown" role="button"
                            data-bs-auto-close="outside">
                            <img src="assets/images/avatarn.jpg" alt="user-image" class="img-fluid user-avtar me-0" />
                        </a>
                        <div class="dropdown-menu dropdown-menu-end nxl-h-dropdown nxl-user-dropdown">
                            <div class="dropdown-header">
                                <div class="d-flex align-items-center">
                                    <img src="assets/images/avatarn.jpg" alt="user-image"
                                        class="img-fluid user-avtar" />
                                    <div>
                                        <h6 class="text-dark mb-0">Abdiaziiz Abdale<span
                                                class="badge bg-soft-success text-success ms-1">PRO</span></h6>
                                        <span class="fs-12 fw-medium text-muted">cabdacasiiscabdle@gmail.com</span>
                                    </div>
                                </div>
                            </div>
                            <div class="dropdown">
...
<style>
    .nxl-container { background: #f8f9fa; min-height: 100vh; }
    .card { border-radius: 12px; }
    .info-label { font-size: 0.75rem; text-transform: uppercase; letter-spacing: 1px; font-weight: 700; color: #adb5bd; }
    .info-value { font-size: 1rem; font-weight: 600; color: #2d3436; }
    .badge-soft-pending { background: #fff4e6; color: #fd7e14; border: 1px solid #ffe8cc; }
    .badge-soft-completed { background: #ebfbee; color: #40c057; border: 1px solid #d3f9d8; }
    .badge-soft-canceled { background: #fff5f5; color: #fa5252; border: 1px solid #ffe3e3; }
    .stats-box { background: #f1f3f5; border-radius: 8px; padding: 12px; }
...
<main class="nxl-container">
            ...
            <div>
                <nav aria-label="breadcrumb" class="no-print">
                    <ol class="breadcrumb small mb-2">
                        <li class="breadcrumb-item"><a href="property_list.php">Inquiries</a></li>
                        <li class="breadcrumb-item active">Details</li>
                    </ol>
                </nav>
                <h3 class="fw-bold mb-0 text-dark"><i class="bi bi-file-earmark-text me-2 text-primary"></i>Inquiry Report</h3>
            </div>
            <div class="d-flex gap-2 no-print">
                <a href="property_list.php" class="btn btn-light border px-4 fw-bold">BACK</a>
                <button onclick="window.print()" class="btn btn-dark px-4 fw-bold shadow-sm">PRINT REPORT</button>
            </div>
        </div>
            ...
            <div class="col-lg-4">
                <div class="card border-0 shadow-sm mb-4">
                    <div class="card-body p-4 text-center">
                        <div class="avatar-label bg-light text-primary rounded-circle mx-auto mb-3 d-flex align-items-center justify-content-center" style="width: 60px; height: 60px; font-size: 24px;">
                            <i class="bi bi-person"></i>
                        </div>
                        <h5 class="fw-bold mb-1"><?php echo htmlspecialchars($row['full_name']); ?></h5>
                        <span class="badge <?php echo ($row['status'] == 'Completed') ? 'badge-soft-completed' : (($row['status'] == 'Canceled') ? 'badge-soft-canceled' : 'badge-soft-pending'); ?> px-3 py-2">
                            <?php echo $row['status']; ?>
                        </span>
                        
                        <div class="mt-4 text-start">
                            <h6 class="info-label border-bottom pb-2 mb-3">Customer Details</h6>
                            <div class="mb-3">
                                <label class="info-label d-block">Phone</label>
                                <span class="info-value"><?php echo htmlspecialchars($row['phone']); ?></span>
                            </div>
                            <div class="mb-3">
                                <label class="info-label d-block">Email</label>
                                <span class="info-value"><?php echo htmlspecialchars($row['email'] ?: 'N/A'); ?></span>
                            </div>
                            <div>
                                <label class="info-label d-block">City</label>
                    ...
                    <div class="card-body p-4">
                        <div class="row align-items-center">
                            <div class="col-md-4 mb-3 mb-md-0">
                                <img src="uploads/<?php echo $row['property_thumb']; ?>" class="rounded w-100" style="height: 180px; object-fit: cover; border: 1px solid #eee;">
                            </div>
                            <div class="col-md-8">
                                <div class="d-flex justify-content-between">
                                    <h4 class="fw-bold mb-1"><?php echo htmlspecialchars($row['property_name'] ?? 'General Inquiry'); ?></h4>
                                    <h4 class="text-primary fw-bold"><?php echo $display_price; ?></h4>
                                </div>
                                <p class="text-muted small"><i class="bi bi-geo-alt me-1"></i><?php echo htmlspecialchars($row['location'] ?? 'N/A'); ?></p>
                                
                                <div class="row g-2 mt-2">
                                    <div class="col-4">
                                        <div class="stats-box text-center">
                                            <small class="text-muted d-block">Beds</small>
                                            <span class="fw-bold"><?php echo $row['beds'] ?? 0; ?></span>
                                        </div>
                                    </div>
                                    <div class="col-4">
                                        <div class="stats-box text-center">
                                            <small class="text-muted d-block">Baths</small>
                                            <span class="fw-bold"><?php echo $row['baths'] ?? 0; ?></span>
                                        </div>
                                    </div>
                                    <div class="col-4">
                                        <div class="stats-box text-center">
                                            <small class="text-muted d-block">Size</small>
                                            <span class="fw-bold"><?php echo $row['size'] ?? 'N/A'; ?></span>
                                        </div>
                                    </div>
                                </div>
                            </div>
    ...
    <footer class="footer d-flex align-items-center justify-content-between flex-wrap gap-3">
        <p class="fs-11 text-muted fw-medium text-uppercase mb-0 copyright">
            <span>Copyright ©</span>
            <script>
                document.write(new Date().getFullYear());
            </script>
            <span class="ms-1">HADAF-KAAL TRAVEL & SERVICES</span>
        </p>

        <p class="mb-0 fs-11 fw-medium text-muted">
            Developed by: <a href="mailto:cabdacasiiscabdle@gmail.com" class="text-primary fw-bold">Abdiaziiz Abdale
                Salim</a>
        ...
        <div class="d-flex align-items-center gap-4">
            <a href="mailto:cabdacasiiscabdle@gmail.com" class="fs-11 fw-semibold text-uppercase text-muted">Support</a>
