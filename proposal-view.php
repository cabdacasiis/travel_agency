...
<head>
    ...
    <!--! BEGIN: Apps Title-->
    <title>Duralux || Proposal View</title>
    <!--! END:  Apps Title-->
    <!--! BEGIN: Favicon-->
                                ...
                                <div class="card stretch stretch-full">
                                    ...
                                    <div class="card-body p-0">
                                        <div data-editor-target="editor-proposal" class="ht-300 font-inter botder-top-0">
                                            ...
                                            <br>
                                            <p>Web design companies vary greatly in terms of size, focus, and services offered. Some are large, full-service agencies that work with big-name Customers, while others are small, boutique studios that specialize in creating unique, custom websites for smaller businesses.</p>
                                            <br>
                                    ...
                                    <div class="card-body">
                                        ...
                                        <ul class="list-unstyled text-muted mb-0">
                                            ...
                                            <li class="d-flex align-items-start mb-3">
                                                ...
                                                <span>Utilized HTML, CSS, and JavaScript to create 100+ responsive landing pages for both company and Customer. </span>
                                            </li>
                                            <li class="d-flex align-items-start mb-3">
                                                <span class="avatar-text avatar-sm bg-soft-success text-success me-3">
                                                    <i class="feather-check fs-10"></i>
                                ...
                                <div class="card stretch stretch-full">
                                    ...
                                    <div class="card-body task-checklist">
                                        <ul class="list-unstyled" id="checklist">
                                            ...
                                            <li>Utilized HTML, CSS, and JavaScript to create 100+ responsive landing pages for both company and Customer.</li>
    ...
    <div class="offcanvas offcanvas-end" tabindex="-1" id="proposalSent">
        <div class="offcanvas-header ht-80 px-4 border-bottom border-gray-5">
            <div>
                ...
                <small class="fs-12 text-muted">Sent proposal to your Customer's</small>
            </div>
        ...
        <div class="offcanvas-body">
            <div class="form-group mb-4">
                ...
                <input type="email" class="form-control" value="wrapcode.info@gmail.com" placeholder="Customers..." readonly="" required>
            </div>
            <div class="form-group mb-4">
