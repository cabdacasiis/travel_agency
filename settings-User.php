<?php
// 1. Tan waa inay noqotaa dhibicda 1aad ee faylka
...
<body>
                                ...
                                <form action="" method="POST" id="userForm">
                                    ...
                                    <div class="row">
                                        <div class="col-md-6 mb-4">
                                            ...
                                            <input type="text" name="full_name" class="form-control" placeholder="Abdiaziiz Abdale Salim" required>
                                        </div>

                                        <div class="col-md-6 mb-4">
                                            <label class="form-label fw-bold">Username</label>
                                            <input type="text" name="username" class="form-control" placeholder="Jama" required>
                                        </div>

                                        <div class="col-md-6 mb-4">
                                            <label class="form-label fw-bold">Mobile</label>
                                            <input type="tel" name="mobile" class="form-control" placeholder="907097163" required>
                                        </div>

                                        <div class="col-md-6 mb-4">
                                            <label class="form-label fw-bold">Address</label>
                                            <input type="text" name="address" class="form-control" placeholder="Garowe, Somalia" required>
                                        </div>
                                        ...
                                        <div class="col-md-6 mb-4">
                                            ...
                                            <div class="input-group">
                                                ...
                                                <span class="input-group-text c-pointer" id="togglePassword">
                                    ...
                                    <div class="page-header-right ms-auto mt-4">
                                        <div class="d-flex align-items-center gap-3">
                                            <a href="users-list.php" class="text-danger fw-bold text-decoration-none">Cancel</a>
                                            <button type="submit" name="add_user_btn" class="btn btn-primary d-flex align-items-center">
    ...
    <?php
// 1. Hubi in xiriirka database-ka uu jiro (conn.php)
require_once "conn.php"; 

// 2. Bilow Session-ka haddii uusan horay u furnayn
if (session_status() === PHP_SESSION_NONE) {
    session_start();
}

if (isset($_POST['add_user_btn'])) {
    // Ka soo qaad xogta foomka
    ...
    // SQL Query
    $sql = "INSERT INTO admin_users (username, password, full_name, mobile, adderess, status) 
            VALUES ('$username', '$password', '$full_name', '$mobile', '$address', '$status')";

    if (mysqli_query($con, $sql)) {
        $_SESSION['success'] = "User cusub ayaa si guul leh loogu daray database-ka!";
        // Isticmaalka JavaScript si looga fogaado "Headers already sent"
        echo "<script>window.location.href='list-user.php';</script>";
        exit();
    } else {
        echo "Khalad ayaa dhacay: " . mysqli_error($con);
    }
} // <-- Xiritaanka dhabta ah ee 'if (isset($_POST...))'
?>
    <!-- <script>
