                            ...
                            <div class="dropdown-menu nxl-h-dropdown">
                                ...
                                <div class="dropdown nxl-level-menu">
                                    ...
                                    <div class="dropdown-menu nxl-h-dropdown">
                                        ...
                                        <a href="customers-care.php" class="dropdown-item">
                                            <i class="wd-5 ht-5 bg-gray-500 rounded-circle me-3"></i>
                            ...
                            <div class="dropdown-menu nxl-h-dropdown" id="mega-menu-dropdown">
                                <div class="d-lg-flex align-items-start">
                                    ...
                                    <div class="nav flex-column nxl-mega-menu-tabs" role="tablist" aria-orientation="vertical">
                                        <button class="nav-link active nxl-mega-menu-sm" data-bs-toggle="pill" data-bs-target="#v-pills-User" type="button" role="tab">
                                            ...
                                            <div class="row g-4">
                                                ...
                                                <div class="col-lg-6">
                                                    <div class="nxl-mega-menu-image">
                                                        <img src="assets/images/User/full-avatar.png" alt="" class="img-fluid full-user-avtar">
                                                    </div>
                                                </div>
                                            </div>
                                    ...
                                    <div class="d-flex align-items-center justify-content-between mb-4">
                                        <div class="d-flex align-items-center gap-3">
                                            ...
                                            <div>
                                                ...
                                                <p class="fs-11 text-muted mb-0">cabdacasiiscabdle@gmail.com</p>
                                            </div>
                                        </div>
                                ...
                                <div class="hstack gap-3 justify-content-between">
                                    <div class="hstack gap-3">
                                        ...
                                        <div class="ps-3 border-start border-3 border-primary rounded">
                                            <a href="javascript:void(0);" class="fw-semibold mb-1 text-truncate-1-line">Meeting with new Customers.</a>
                                ...
                                <div class="hstack gap-3 justify-content-between">
                                    <div class="hstack gap-3">
                                        ...
                                        <div class="ps-3 border-start border-3 border-danger rounded">
                                            <a href="javascript:void(0);" class="fw-semibold mb-0 text-truncate-1-line">Meeting with new Customers.</a>
                                            <a href="javascript:void(0);" class="fs-12 text-muted">
                                                <i class="feather-message-square fs-10 me-1"></i>
                                                <span class="fw-normal">Google Meet</span>
                                            </a>
                            ...
                            <div class="card-body custom-card-action">
                                <div class="d-flex align-items-center">
                                    ...
                                    <div class="d-flex align-items-center justify-content-between border-3 border-start border-primary rounded w-100">
                                        <div class="mx-3">
                                            <a href="javascript:void(0);" class="fw-semibold mb-1 text-truncate-1-line">Create a new project for Customer</a>
                                ...
                                <div class="d-flex align-items-center justify-content-between">
                                    <div class="d-flex align-items-center">
                                        ...
                                        <div class="ms-3">
                                            ...
                                            <div class="fs-12 text-muted fw-normal">All feeback from your Customers</div>
                                        </div>
                                    </div>
                                    <div class="avatar-text avatar-md">
                                        <i class="feather feather-arrow-right"></i>
                                ...
                                <div class="d-flex align-items-center justify-content-between">
                                    <div class="d-flex align-items-center">
                                        ...
                                        <div class="ms-3">
                                            ...
                                            <div class="fs-12 text-muted fw-normal">All request from your Customers</div>
                                        </div>
                                    </div>
                                    <div class="avatar-text avatar-md">
                                        <i class="feather feather-arrow-right"></i>
                                ...
                                <div class="d-flex align-items-center justify-content-between">
                                    <div class="d-flex align-items-center">
                                        ...
                                        <div class="ms-3">
                                            ...
                                            <div class="fs-12 text-muted fw-normal">All new order from your Customers</div>
                                        </div>
                                    </div>
                                    <div class="avatar-text avatar-md">
                                        <i class="feather feather-arrow-right"></i>
                                ...
                                <div class="pd-x-30 pd-y-15 d-flex justify-content-between">
                                    <div class="d-flex">
                                        ...
                                        <div class="ps-3">
                                            ...
                                            <span class="fs-12 text-muted">Customers ID: #963258</span>
                                        </div>
                                    </div>
                                    <div class="text-end">
                                        <div>
                                ...
                                <div class="pd-x-30 pd-t-30 pd-b-15 d-flex justify-content-between">
                                    <div class="d-flex">
                                        ...
                                        <div class="ps-3">
                                            ...
                                            <span class="fs-12 text-muted">Customers ID: #251362</span>
                                        </div>
                                    </div>
                                    <div class="text-end">
                                        <div>
                                ...
                                <div class="pd-x-30 pd-y-15 d-flex justify-content-between">
                                    <div class="d-flex">
                                        ...
                                        <div class="ps-3">
                                            ...
                                            <span class="fs-12 text-muted">Customers ID: #589647</span>
                                        </div>
                                    </div>
                                    <div class="text-end">
                                        <div>
                                ...
                                <div class="pd-x-30 pd-y-15 d-flex justify-content-between">
                                    <div class="d-flex">
                                        ...
                                        <div class="ps-3">
                                            ...
                                            <span class="fs-12 text-muted">Customers ID: #789654</span>
                                        </div>
                                    </div>
                                    <div class="text-end">
                                        <div>
                                ...
                                <div class="pd-x-30 pd-y-15 d-flex justify-content-between">
                                    <div class="d-flex">
                                        ...
                                        <div class="ps-3">
                                            ...
                                            <span class="fs-12 text-muted">Customers ID: #357951</span>
                                        </div>
                                    </div>
                                    <div class="text-end">
                                        <div>
                            ...
                            <div class="card-body">
                                <div class="mb-4 text-center">
                                    ...
                                    <div class="mb-4">
                                        ...
                                        <a href="javascript:void(0);" class="fs-12 fw-normal text-muted d-block">cabdacasiiscabdle@gmail.com</a>
                                    </div>
                                ...
                                <ul class="list-unstyled mb-4">
                                    ...
                                    <li class="hstack justify-content-between mb-0">
                                        ...
                                        <a href="javascript:void(0);" class="float-end">cabdacasiiscabdle@gmail.com</a>
                                    </li>
                                </ul>
                                    ...
                                    <table class="table table-hover mb-0">
                                        ...
                                        <tbody>
                                            ...
                                            <tr class="mb-1">
                                                ...
                                                <td>
                                                    <a href="javascript:void(0);">Marketing meeting with Customers <span class="fs-12 fw-normal text-muted">(20/02/2023)</span> </a>
                                                    <p class="fs-12 text-muted text-truncate-1-line tickets-sort-desc">Lorem ipsum dolor, sit amet consectetur adipisicing elit.</p>
                                                    <div class="tickets-list-action d-flex align-items-center gap-3">
                                                        <a href="javascript:void(0);">View</a>
                                                        <span>|</span>
                            ...
                            <div class="card-body">
                                ...
                                <div class="text-center">
                                    <div class="wd-150 mx-auto my-4">
                                        <img src="assets/images/User/rocket.png" class="img-fluid" alt="">
                                    </div>
