                ...
                <div class="page-header-right ms-auto">
                    <div class="page-header-right-items">
                        ...
                        <div class="d-flex align-items-center gap-2 page-header-right-items-wrapper">
                            ...
                            <a href="customers-care.php" class="btn btn-primary">
                            ...
                            <div class="tab-content">
                                <div class="tab-pane fade show active p-4" id="overviewTab" role="tabpanel">
                                    <div class="about-section mb-5">
                                        ...
                                        <p>Throughout his career, John has worked on a wide range of projects for Customers in various industries, including e-commerce, healthcare, and education. He takes a collaborative approach to development and enjoys working closely with Customers and other developers to bring their ideas to life.</p>
                                    </div>
                                    <div class="profile-details mb-5">
                                        ...
                                        <div class="row g-0 mb-4">
                                            ...
                                            <div class="col-sm-6 fw-semibold">cabdacasiiscabdle@gmail.com</div>
                                        </div>
                                        <div class="row g-0 mb-4">
