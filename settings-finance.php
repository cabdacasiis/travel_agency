...
<head>
    ...
    <!--! BEGIN: Apps Title-->
    <title>Duralux || Finance Settings</title>
    <!--! END:  Apps Title-->
    <!--! BEGIN: Favicon-->
                ...
                <div class="content-sidebar content-sidebar-md" data-scrollbar-target="#psScrollbarInit">
                    ...
                    <div class="content-sidebar-body">
                        <ul class="nav flex-column nxl-content-sidebar-item">
                            <li class="nav-item">
                                <a class="nav-link" href="settings-User.php">
                                    <i class="feather-airplay"></i>
                                    <span>User</span>
                                </a>
                            </li>
                ...
                <div class="content-area" data-scrollbar-target="#psScrollbarInit">
                    ...
                    <div class="content-area-body">
                        <div class="card mb-0">
                            <div class="card-body">
                                <div class="mb-5">
                                    <h4 class="fw-bold">Finance User</h4>
                                    <div class="fs-12 text-muted">Financial User settings</div>
                                </div>
                                <div class="mb-5">
                                ...
                                <div class="mb-5">
                                    <label class="form-label">Require Customer to be logged in to view invoice </label>
                                    <select class="form-select" data-select2-selector="icon">
                                        <option value="" data-icon="feather-check text-success">Yes</option>
                                        <option value="" data-icon="feather-x text-danger" selected>No</option>
                                    </select>
                                    <small class="form-text text-muted">Require Customer to be logged in to view invoice [Ex: Yes/No]</small>
                                </div>
                                <div class="mb-5">
                                ...
                                <div class="mb-5">
                                    <label class="form-label">Predefined Customer Note</label>
                                    <textarea cols="30" rows="10" class="form-control" placeholder="Predefined Customer Note"></textarea>
                                    <small class="form-text text-muted">Predefined Customer Note</small>
                                </div>
                                <div class="mb-5">
