...
// Hubi haddii uu xiriirku guulaystay
if (!$con) {
    die("Succesfully: " . mysqli_connect_error());
}

// Haddii aad rabto inaad hubiso inuu shaqaynayo (waa iska saari kartaa hadhow)
// echo "Xiriirku waa sax!"; 
?>
<!DOCTYPE html>
<html lang="zxx">
...
<?php
// Soo geli xiriirka database-ka
include 'conn.php'; // Hubi inuu yahay feylka aad ku qortay $con

if (isset($_POST['save_property'])) {
    // Ka qaad xogta form-ka
    $title    = $_POST['title'];
    ...
    $folder     = "assets/images/" . $image_name; // Hubi in folder-kani jiro

    // Amarka lagu kaydinayo database-ka
    $query = "INSERT INTO properties (title, location, price, category, image, beds, baths, size) 
              VALUES ('$title', '$location', '$price', '$category', '$image_name', '$beds', '$baths', '$size')";
    ...
    if ($result) {
        ...
        echo "Khalad ayaa dhacay: " . mysqli_error($con);
    }
}
?>
  ...
  <form action="save_property.php" method="POST" enctype="multipart/form-data">
    <div class="row g-3">
        <div class="col-md-6">
            ...
            <input type="text" name="title" class="form-control" placeholder="Al Furqaan Luxury Suite" required>
        </div>
        
        <div class="col-md-6">
            <label class="form-label fw-bold">Location</label>
            <input type="text" name="location" class="form-control" placeholder="Wadajir, Garowe" required>
        </div>

        <div class="col-md-6">
            <label class="form-label fw-bold">Price ($)</label>
            <input type="text" name="price" class="form-control" placeholder="Tusaale: $350/mo ama 85,000" required>
        </div>
        ...
        <div class="col-md-6">
            ...
            <input type="text" name="size" class="form-control" placeholder="Tusaale: 120sqm" required>
        </div>

        <div class="col-md-6">
            <label class="form-label fw-bold">Beds</label>
            <input type="number" name="beds" class="form-control" value="0" min="0" required>
        </div>

        <div class="col-md-6">
            <label class="form-label fw-bold">Baths</label>
            <input type="number" name="baths" class="form-control" value="0" min="0" required>
        </div>
    </div>

    <div class="d-flex align-items-center gap-3 mt-4">
        <button type="submit" class="btn btn-primary d-flex align-items-center gap-2">
            <i class="feather-save"></i> SAVE PROPERTY
        </button>
        <a href="service_list.php" class="text-danger fw-bold text-uppercase fs-11">Cancel</a>
    </div>
</form>
</div>
</main>
