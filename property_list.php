...
// Query-ga oo lagu daray JOIN si sawirka iyo magaca guriga loo helo
$query = "SELECT pb.*, p.title as property_name, p.image as property_thumb 
...
if ($result) {
    ...
    echo "Cilad SQL: " . mysqli_error($con);
}
?>
<!DOCTYPE html>
<html lang="zxx">
...
<head>
    ...
    <style>
    /* 🔥 Fix dropdown go'aya (overflow issue) */
    .table-responsive,
    .card,
    .card-body {
    ...
    /* 🔥 Dropdown ha ka sarreeyo wax walba */
    .dropdown-menu {
    ...
    /* 🔥 Dropdown items styling (clean UI) */
    .dropdown-item {
        font-size: 14px;
                ...
                <ul class="nxl-navbar">
                    ...
                    <li class="nxl-item nxl-hasmenu">
                        ...
                        <ul class="nxl-submenu">
                            ...
                            <li class="nxl-item"><a class="nxl-link" href="customers-create.php">Customers Create</a>
                            </li>
                        </ul>
                    </li>
                    ...
                    <li class="nxl-item nxl-hasmenu">
                        <a href="javascript:void(0);" class="nxl-link">
                            ...
                            <span class="nxl-mtext">Service</span><span class="nxl-arrow"><i
                                    class="feather-chevron-right"></i></span>
                        </a>
                        <ul class="nxl-submenu">
                            <li class="nxl-item"><a class="nxl-link" href="service_list.php">Add Services</a></li>
            ...
            <div class="page-header">
                <div class="page-header-left d-flex align-items-center">
                    <div class="page-header-title">
                        <h5 class="m-b-10">Real Estate Inquiries</h5>
                    </div>
                    <ul class="breadcrumb">
                        <li class="breadcrumb-item"><a href="index.php">Dashboard</a></li>
                        <li class="breadcrumb-item">Property Requests</li>
                    </ul>
                </div>
                <div class="page-header-right ms-auto no-print">
                    <button onclick="window.print()"
                        class="btn btn-primary shadow-sm d-flex align-items-center px-3 py-2">
                        <i class="feather-printer me-2"></i>
                        <span class="fw-bold text-uppercase small" style="letter-spacing: 0.5px;">Print Report</span>
                    </button>
                </div>
            </div>
                                        ...
                                        <tbody>
                                            ...
                                            <tr>
                                                <td class="ps-4">
                                                    <div class="d-flex align-items-center">
                                                        <div
                                                            class="avatar-text bg-soft-primary text-primary rounded-circle me-3">
                                                            <?php echo strtoupper(substr($row['full_name'], 0, 1)); ?>
                                                        </div>
                                                        <div>
                                                            <span
                                                                class="fw-bold text-dark d-block"><?php echo htmlspecialchars($row['full_name']); ?></span>
                                                            <small class="text-muted"><i
                                                                    class="bi bi-phone me-1"></i><?php echo htmlspecialchars($row['phone']); ?></small>
                                                        </div>
                                                    </div>
                                                </td>
                                                ...
                                                <td>
                                                    <div class="d-flex align-items-center">
                                                        <?php 
            // 1. Qeex halka ay sawiradu ku jiraan (Galka uploads)
            $folder = "uploads/"; 
            $imageName = $row['property_thumb'];
            $imgPath = $folder . $imageName;

            // 2. Hubi haddii sawirku jiro oo uusan database-ku madhnayn
            if (!empty($imageName) && file_exists($imgPath)) {
                $finalImg = $imgPath;
            } else {
                // Haddii la waayo, isticmaal sawirkan (hubi inuu jiro path-kan)
                $finalImg = "assets/img/no-image.png"; 
            }
        ?>
                                                        <img src="<?php echo $finalImg; ?>" class="rounded me-2"
                                                            width="45" height="45"
                                                        ...
                                                        <div class="d-flex flex-column">
                                                            <span class="text-truncate fw-medium"
                                                                ...
                                                                <?php echo htmlspecialchars($row['property_name'] ?? 'General Inquiry'); ?>
                                                            </span>
                                                        </div>
                                                    </div>
                                                </td>
                                                ...
                                                <td>
                                                    <div class="d-flex flex-column">
                                                        <span class="text-dark fw-bold">
                                                            <i class="feather-map-pin me-1 text-primary"
                                                                style="font-size: 12px;"></i>
                                                            <?php echo htmlspecialchars($row['city'] ?? 'Garowe'); ?>
                                                        </span>
                                                        <small class="text-muted text-uppercase fw-medium"
                                                            style="font-size: 10px; letter-spacing: 0.5px;">
                                                            <?php echo htmlspecialchars($row['nationality'] ?? 'SOMALI'); ?>
                                                        </small>
                                                    </div>
                                                </td>
                                                ...
                                                <td>
                                                    <?php 
                                                            ...
                                                            if($status == 'Canceled') $badgeClass = 'bg-soft-danger text-danger';
                                                        ?>
                                                    <span
                                                        ...
                                                        <ul
                                                            ...
                                                            <li>
                                                                <a class="dropdown-item d-flex align-items-center py-2"
                                                                    href="property_view.php?id=<?php echo $row['id']; ?>">
                                                                    <i class="bi bi-eye me-2" style="width:20px;"></i>
                                                                    <span>View</span>
                                                                </a>
                                                            </li>
                                                            ...
                                                            <li>
                                                                <a class="dropdown-item d-flex align-items-center py-2 text-success"
                                                                    href="https://wa.me/<?php echo preg_replace('/[^0-9]/', '', $row['phone']); ?>"
                                                                    target="_blank">
                                                            ...
                                                            <li>
                                                                <a class="dropdown-item d-flex align-items-center py-2 text-info"
                                                                    href="property_edit.php?id=<?php echo $row['id']; ?>">
                                                            ...
                                                            <li>
                                                                <a class="dropdown-item d-flex align-items-center py-2 text-danger"
                                                                    href="property_delete.php?id=<?php echo $row['id']; ?>"
                                                                    onclick="return confirm('Ma hubtaa?')">
                                                                    <i class="bi bi-trash me-2" style="width:20px;"></i>
                                                                    <span>Delete</span>
                                                                </a>
                                                            </li>
                                            ...
                                            <tr>
                                                <td colspan="7" class="text-center py-5">
                                                    <p class="text-muted">Lama helin wax dalab ah (No Inquiries Found).
                                                    </p>
                                                </td>
                                            </tr>
                                            <?php endif; ?>
