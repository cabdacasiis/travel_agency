...
// Hubi in qofka uu login yahay
if (!isset($_SESSION['admin_id'])) {
    header("Location: login.php");
    exit();
}

// Xogta laga soo saarayo table-ka properties
    ...
    <div class="nxl-content">
        <div class="page-header">
            <div class="page-header-left">
                <h5 class="m-b-10">Property Inventory</h5>
                <ul class="breadcrumb">
                    <li class="breadcrumb-item"><a href="index.php">Home</a></li>
                    <li class="breadcrumb-item">Full Details List</li>
                </ul>
            </div>
            <div class="page-header-right ms-auto">
                <a href="service_add.php" class="btn btn-primary">
                    <i class="feather-plus me-2"></i><span>Add Property</span>
                </a>
            </div>
        </div>
    ...
    <tbody>
        <?php while($row = mysqli_fetch_assoc($result)): ?>
            <tr>
                ...
                <td><img src="uploads/<?php echo $row['image']; ?>" width="45" class="rounded"></td>
                <td><?php echo htmlspecialchars($row['title']); ?></td>
                
                <td>
                    <?php 
                        $statusClass = 'bg-soft-success text-success'; // Active
                        if($row['status'] == 'Pending') $statusClass = 'bg-soft-warning text-warning';
                        if($row['status'] == 'Sold') $statusClass = 'bg-soft-danger text-danger';
                    ?>
                ...
                <td>
                    <small><?php echo $row['beds']; ?>B | <?php echo $row['baths']; ?>Ba | <?php echo $row['size']; ?></small>
                </td>
                <td class="text-end">
                    <div class="hstack gap-2 justify-content-end">
                        <a href="service_edit.php?id=<?php echo $row['id']; ?>" class="btn btn-sm btn-light-warning"><i class="feather-edit-3"></i></a>
                        <a href="service_delete.php?id=<?php echo $row['id']; ?>" class="btn btn-sm btn-light-danger"><i class="feather-trash-2"></i></a>
                    </div>
                </td>
            </tr>
        <?php endwhile; ?>
