                        ...
                        <div class="card border-top-0">
                            <div class="card-body p-0" id="project-create-steps">
                                    ...
                                    <form id="project-details">
                                        <fieldset>
                                            ...
                                            <fieldset>
                                                ...
                                                <div class="mb-4">
                                                    <label for="projectCustomer" class="form-label">Project Customer <span class="text-danger">*</span></label>
                                                    <select id="projectCustomer" class="form-select" name="projectCustomer">
                                                        <option value="1" data-user="1" selected>Abdiaziiz Abdale- Website design and development</option>
                                                        ...
                                                        <option value="6" data-user="6">Abdiaziiz Abdale- Website design and development</option>
                                ...
                                <section class="step-body mt-4 text-center">
                                    <img src="assets/images/User/completed-steps.png" alt="" class="img-fluid wd-300 mb-4">
