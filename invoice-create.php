                                ...
                                <div class="row px-4 justify-content-between">
                                    ...
                                    <div class="col-xl-5">
                                        ...
                                        <div class="form-group row mb-3">
                                            ...
                                            <div class="col-sm-9">
                                                <input type="text" class="form-control" id="CustomerName" placeholder="Business Name">
                                            </div>
                                        </div>
                                        <div class="form-group row mb-3">
                                        ...
                                        <div class="form-group row">
                                            ...
                                            <div class="col-sm-9">
                                                <textarea rows="5" class="form-control" id="CustomerAddress" placeholder="Enter Address"></textarea>
                                            </div>
                                        </div>
                                    </div>
                                </div>
                    ...
                    <div class="col-xl-4">
                            ...
                            <div class="card-body">
                                ...
                                <div class="tab-content mt-4">
                                    ...
                                    <div class="tab-pane fade" id="pamymetPaypalTab" role="tabpanel">
                                        ...
                                        <p>
                                            <a href="http://paypal.com"  class="btn btn-primary"><i class="bi bi-paypal me-2"></i> Log in my Paypal</a>
                                        </p>
                        ...
                        <div class="card stretch stretch-full">
                            <div class="card-body">
                                ...
                                <div class="ps-0 mb-3 form-check form-switch form-switch-sm d-flex align-center justify-content-between">
                                    <label class="fw-bold text-dark" for="CustomerNote">
                                        <span>Customer Notes</span>
                                        <span class="fs-11 fw-normal text-muted d-block">Customer notes for further query</span>
                                    </label>
