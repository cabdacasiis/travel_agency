...
<head>
    ...
    <!--! BEGIN: Apps Title-->
    <title>Duralux || Localization Settings</title>
    <!--! END:  Apps Title-->
    <!--! BEGIN: Favicon-->
                    ...
                    <div class="content-area-body">
                        <div class="card mb-0">
                            <div class="card-body">
                                ...
                                <div class="mb-5">
                                    <label class="form-label"> Output Customer PDF documents from admin area in Customer language </label>
                                    <select class="form-select" data-select2-selector="icon">
                                    ...
                                    <small class="form-text text-muted"> Output Customer PDF documents from admin area in Customer language [Ex: Yes/No]</small>
                                </div>
                                <div class="mb-5">
