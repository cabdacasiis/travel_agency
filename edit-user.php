...
// Hubi in ID-gu uu ku jiro URL-ka
if (isset($_GET['id'])) {
    ...
    if (mysqli_num_rows($query) > 0) {
        ...
        die("User-kan laguma helin database-ka.");
    }
} else {
    die("ID-ga lama soo dirin.");
}
?>... koodhka kale ee PHP halkan geli ...
?>
...
<head>
    ...
    <!--! BEGIN: Apps Title-->
    <title>Duralux || User Settings</title>
    <!--! END:  Apps Title-->
    <!--! BEGIN: Favicon-->
                ...
                <div class="content-area" data-scrollbar-target="#psScrollbarInit">
                                ...
                                <form method="POST">
                                    ...
                                    <div class="mb-3">
                                        ...
                                        <select name="status" class="form-control">
                                            <option value="Active"
                                                <?php if($user['status'] == 'Active') echo 'selected'; ?>>Active
                                            </option>
                                            <option value="Inactive"
                                                <?php if($user['status'] == 'Inactive') echo 'selected'; ?>>Inactive
                                            </option>
                                        </select>
                                    </div>
                                    <button type="submit" name="update_user_btn" class="btn btn-success">Update
                                        User</button>
                                </form>
                            </div>
                        </div>
                    ...
                    <footer class="footer">
                        <p class="fs-11 text-muted fw-medium text-uppercase mb-0 copyright">
                            <span>Copyright © Abdiaziiz Abdale Salim </span>
                            <script>
...
if (isset($_POST['update_user_btn'])) {
    ...
    $sql = "UPDATE admin_users SET full_name='$full_name', mobile='$mobile', status='$status' WHERE id=$id";

    if (mysqli_query($con, $sql)) {
        echo "<script>alert('Waa la update-gareeyay!'); window.location.href='list-user.php';</script>";
    }
}
?>
    <!--! ================================================================ !-->
