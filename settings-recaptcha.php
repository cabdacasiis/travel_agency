...
<head>
    ...
    <!--! BEGIN: Apps Title-->
    <title>Duralux || reCAPTCHA Settings</title>
    <!--! END:  Apps Title-->
    <!--! BEGIN: Favicon-->
                ...
                <div class="content-area" data-scrollbar-target="#psScrollbarInit">
                    ...
                    <div class="content-area-body">
                        <div class="card mb-0">
                            <div class="card-body">
                                <div class="mb-5">
                                    <label class="form-label">Google API Customer ID</label>
                                    <input type="text" class="form-control" placeholder="Google API Customer ID">
                                    <small class="form-text text-muted">Google API Customer ID [Ex: G-theme_ocean-2023]</small>
                                </div>
                                <div class="mb-5">
