...
<head>
    ...
    <!--! BEGIN: Apps Title-->
    <title>Duralux || Miscellaneous Settings</title>
    <!--! END:  Apps Title-->
    <!--! BEGIN: Favicon-->
                ...
                <div class="content-area" data-scrollbar-target="#psScrollbarInit">
                    ...
                    <div class="content-area-body">
                        <div class="card mb-0">
                            <div class="card-body">
                                <div class="mb-5">
                                    <label class="form-label">Require Customer to be logged in to view contract </label>
                                    ...
                                    <small class="form-text text-muted">Require Customer to be logged in to view contract [Ex: Yes/No]</small>
                                </div>
                                <div class="mb-5">
